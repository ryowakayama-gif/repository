...
SEIKA = [
    ("第10期計画_成果物_1_計画本体と管理表.zip", [
        ...
        "第10期計画_計画素案の課題整理.xlsx",
        "第10期計画_管理の統合と成果品の棚卸し.xlsx",
        ...
        "第10期計画_見える化_見込量の入力値（暫定）.xlsx",
        "第10期計画_所得段階別第1号被保険者数の将来推計.xlsx",
