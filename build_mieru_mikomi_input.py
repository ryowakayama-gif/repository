...
_SH = [
    ...
    ("08_給付費と保険料（参考）", "当方の算定と画面の表示の対照",
     "保険料額の算定"),
    ("09_暫定値である理由", "未受領資料と据え置き23件・月額への効き", "―"),
    ("10_自己点検", "本表の内的整合の点検", "―"),
]
...
# ============================================================ 08
ws = sheet("08_給付費と保険料", "給付費と保険料（参考・暫定値）",
           ZANTEI + "　"
...
# ============================================================ 09
ws = sheet("09_暫定値である理由", "なぜ暫定値なのか（未受領資料と据え置き）",
           ZANTEI + "　"
           "本表の値が暫定値である理由を、"
           "受託者の側で確定できるもの（区分A）、"
