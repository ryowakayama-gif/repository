...
r += 1
r = lead(ws, r, "【4　令和7年度の集計の差（令和8年9月25日に解決しました）】", 4)
r = note(ws, r,
         ...
         "令和7年度のみ3町の合計が大雪地区広域連合を1億2,958万円上回って"
         "いました。\n"
         "【令和8年9月25日】令和7年度の広域連合単位のファイルの再提供を受け、"
         "「介護度別給付費」の表の総計が3,213,054,558円となり、"
         "要支援1から要介護5までの全7区分で3町合計と円単位で一致しました。"
         "従前のファイルもその明細を集計すると同じ額になるため、"
         "差は抽出条件の違いではなく表が明細と一致していなかったことに"
         "よるものです。\n"
         "【美瑛町】令和7年度のファイルは、"
         "利用回数のシート名が他年度と異なる（「（東神楽）」となっている）"
         "ものの、収録されている値は美瑛町のものであることを確認しており、"
         "シート名の誤りとして扱います。\n"
         "\n"
