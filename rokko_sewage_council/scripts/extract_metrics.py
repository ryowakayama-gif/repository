...
COSTMAP = {"経常支出 (D)": "経常支出", "経常収入 (C)": "経常収入",
           "営業収益 (A)": "営業収益", "営業外収益": "営業外収益",
           "営業費用": "営業費用", "営業外費用": "営業外費用",
           "経常損益 (C)-(D)": "経常損益", "(1) 使用料収入": "使用料収入", "(1) 職員給与費": "職員給与費", "(2) 経費": "経費", "(1) 経費": "経費",
           "(3) 減価償却費": "減価償却費", "(2) 減価償却費": "減価償却費",
           "(1) 支払利息": "支払利息", "(2) その他": "営業外費用その他",
           "(2) 長期前受金戻入": "長期前受金戻入", "(1) 補助金": "補助金",
           "(2) 雨水処理負担金": "雨水処理負担金",
           "動力費": "動力費", "修繕費": "修繕費", "材料費": "材料費", "その他": "経費その他",
...
def main():
    with tempfile.TemporaryDirectory() as tmp:
        ...
        for label in BOOKS:
            ...
            plan.setdefault("材料費", [0] * 10)              # 農集は材料費の行を持たない
            table["財政計画"] = plan
            metrics[label] = table
