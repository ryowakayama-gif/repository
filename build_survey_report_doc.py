...
P("なお、夜間対応型訪問介護（７件）、定期巡回・随時対応型訪問介護看護（９件）、"
  ...
  "第10期計画の整備方針で検討します。")
P("")
P("これら３サービスに介護医療院を加えた４サービス"
  "（区域内に事業所が存在しないもの）のいずれかを挙げた方は、"
  "複数選択があっても１人１票として数えると%d人です。"
  "この設問の有効回答%d票に対する割合は%.1f%%で、"
  "代表KPI H12（区域内で提供できないサービスが必要と判断された"
  "利用者の割合）の基準値としています。" % (KP.H12_BUNSHI, KP.H12_BUNBO, KP.H12))
NOTE("延べ26件は３サービスの選択件数の合計であり、"
     "上記の%d人は４サービスのいずれかを挙げた実人数です。"
     "数えているものが異なります。"
     "本調査は事業所が在宅生活の継続に課題があると判断した利用者を"
     "抽出して回答する設計であるため、"
     "この割合は区域内の在宅利用者全体の未充足率ではありません。"
     % KP.H12_BUNSHI)
...
P("空きがないが30件と最も多くなっています。"
  "特定施設入居者生活介護は区域内３施設とも入居率が高く"
  "（回答2施設98.3%、公表データによる1施設97.0%。第３章）、"
  "この結果と同じ方向です。")
...
NOTE("同公表画面の「入居率」の欄は100.0%と表示されていますが、"
     "同じ画面の入居者数（男25人・女72人。要介護度別の内訳の合計も同数）は"
     "97人で、定員100人に対して97.0%となります。"
     "公表資料の中で食い違っているため、"
     "本報告書では入居者数から計算した97.0%を用いています。")
...
TBL(["事業所", "町", "訪問介護員等の実人数", "常勤換算",
    ...
    [["指定（介護予防）訪問介護ケンセイシャレバレッジ", "東神楽町",
     ...
     ["訪問介護事業所 ほがらか", "東神楽町",
      "17人（常勤10・非常勤7）", "5.6人", "採用2人・退職6人"],
     ["訪問介護ステーションゆう", "東川町",
      "6人（常勤5・非常勤1）", "6.0人", "採用1人・退職1人"],
     ["美瑛町ホームヘルプサービスセンター", "美瑛町",
      "13人（常勤6・非常勤7）", "6.4人", "採用2人・退職2人"]],
    [5.0, 1.4, 4.4, 2.0, 4.4], num_from=99)
NOTE("これにより、区域内の訪問介護13事業所すべてについて"
     "訪問介護員等の実人数を把握しました。合計181人です。"
     "「回答のあった３事業所」という代表性の限界は解消しました。"
     "10事業所とも本調査の基準日（令和7年4月1日）より前からの指定であり、"
     "基準日に開設していなかったことによる未回答ではありません。"
     "ただし公表画面の記入日は令和7年10月3日から11月7日までであり、"
     "本調査の基準日とは時点が異なります。"
     "本報告書では公表画面によるものを「令和7年10〜11月時点」と"
     "明記して用います。")
NOTE("13事業所の前年度の採用者数は合計23人、退職者数は合計28人で、"
     "５人の減です。"
     "退職が採用を上回るのは、"
     "縁結び（採用6人・退職10人）、ほがらか（採用2人・退職6人）を含む"
     "５事業所です。"
     "ただし公表制度の「前年度」と本調査の「過去1年間」は"
     "対象期間の解釈が異なる可能性があるため、"
     "代表KPI H14（採用率と離職率の差）にはそのまま用いません。")
...
TBL(["区分", "事業所数", "訪問介護員等", "利用者", "事業所"],
    [["併設あり", "８", "128人（70.7%）", "225人（65.0%）",
      "花時計、フラワー、シルバーハウス、ひばり、縁結び、桜華、恩送り、ゆう"],
     ["併設なし", "５", "53人（29.3%）", "121人（35.0%）",
      "３町の社会福祉協議会の３事業所、ケンセイシャレバレッジ及びほがらか"],
     ["計", "13", "181人", "346人", "―"]],
    [2.0, 1.4, 3.4, 3.2, 7.2], num_from=99)
NOTE("併設の判断は、公表画面の建物名の欄又は特色の欄の記載、"
     "北海道の届出済有料老人ホーム一覧及び住所地特例適用施設一覧との"
     "所在地の一致によります。"
     "訪問介護員等181人のうち128人（70.7%）が、"
     "住宅型有料老人ホーム、サービス付き高齢者向け住宅又は"
     "介護付有料老人ホームに併設された事業所に所属しています。"
     "利用者346人のうち225人（65.0%）も同様です。"
...
P("施設・居住系の見込量は、合計では区域内定員の範囲内に収まる見込みです。"
  "ただし種別ごとにみると、地域密着型介護老人福祉施設は"
  "令和11年度に%.1f人となり、定員%d人の%.1f%%に達する見込みです。"
  "また、区域内の施設には他の保険者の被保険者も入居しており"
  "（住所地特例を含む）、定員と見込量の差がそのまま空きを示すものでは"
  "ありません。特定施設は区域内３施設とも入居率が高く、"
  "回答2施設が98.3%%（令和7年4月1日現在）、"
  "公表データによる1施設が97.0%%（令和7年10月6日現在）です"
  "（時点が異なるため合計の入居率98.7%%は参考値です）。"
