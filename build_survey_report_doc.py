...
P("令和６年度の採用者数は%d人、離職者数は%d人で、"
  "差は%+d人です。"
  "採用が離職を上回っていますが、"
  "介護職員%d人に対する離職者の割合は%.1f%%であり、"
  "毎年２割近くが入れ替わっている計算になります。"
  % (SAIYO, RISHOKU, SAIYO - RISHOKU, N_ALL, RISHOKU / N_ALL * 100))
NOTE("単純合計では採用90人・離職67人ですが、"
     "有料老人ホーム華とヘルパーステーションフラワーが"
     "同一の採用７人・離職２人を計上しているため、"
     "介護職員数と同じ考え方により有料老人ホーム側を除いています。"
     "内訳は、施設・通所系が採用69人・離職58人、"
     "訪問系が採用14人・離職７人です。")
