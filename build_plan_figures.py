...
# 令和6〜8年度の推移。大雪は構成3町の単純平均（交付金は市町村に交付される）。
line("fig26_1_kofukin", "保険者機能強化推進交付金等の総合得点の推移",
     ["令和6年度", "令和7年度", "令和8年度"],
     [("大雪地区広域連合", [332.0, 335.3, 334.0]),
      ("北海道", [413.6, 416.5, 432.6]),
      ("全国", [422.4, 435.0, 454.9])],
     "得点（点）", labelfmt="%.1f", figsize=(5.8, 3.0), ylim=(300, 480))

bars("fig26_2_shihyogun", "指標群別の得点（令和8年度）",
     ["推進\n体制・取組", "推進\n活動", "推進\n成果", "支援\n体制・取組", "支援\n活動", "支援\n成果"],
     [("大雪地区広域連合", [94.7, 23.0, 55.0, 71.7, 34.7, 55.0]),
      ("全国", [145.5, 36.9, 47.7, 130.7, 46.5, 47.7])],
     "得点（点）", labelfmt="%.1f", legend_ncol=2, figsize=(6.4, 3.0))

hbars("fig26_3_mokuhyo", "目標別の得点　大雪／全国（令和8年度）",
      ["共通Ⅳ 自立した日常生活（成果）", "支援Ⅰ 介護予防／日常生活支援",
       "推進Ⅲ 介護人材確保・基盤整備", "推進Ⅰ 持続可能な地域のあるべき姿",
       "支援Ⅱ 認知症総合支援", "推進Ⅱ 公正・公平な給付体制",
       "支援Ⅲ 在宅医療・在宅介護連携"],
      [1.153, 0.802, 0.794, 0.631, 0.581, 0.550, 0.444],
