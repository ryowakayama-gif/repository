...
POPULATION = [
    ...
    ("平成31年", 2019, "実績", 2743, 284, 1495, 964,
     "現行計画本編 第2章1"),
    ("令和2年", 2020, "実績", 2697, 276, 1437, 984,
     "現行計画本編 第2章1"),
    ("令和3年", 2021, "実績", 2630, 255, 1369, 1006,
     "現行計画本編 第2章1。老年人口はこの年（1,006人）をピークに減少に転じている"),
    ("令和4年", 2022, "実績", 2535, 231, 1301, 1003,
     "現行計画本編 第2章1"),
    ("令和5年", 2023, "実績", 2443, 205, 1241, 997,
     "現行計画本編 第2章1。手帳所持率の基準年"),
...
# --- 前回アンケート調査（現行計画策定時）---------------------------------
# 出典: 第7期北塩原村障がい福祉計画及び第3期北塩原村障がい児福祉計画策定に係る
#       アンケート調査 調査結果報告書（令和6年3月）4 アンケート回収結果
# 計画本編は「計161人（重複者を除く）」、報告書の発送数は164人（重複3人を含む）。
# 回収率57.9%は164人を分母とした値であり、161人を分母にすると59.0%となる。
PREV_SURVEY = [
    # 区分, 発送数, 回収数, 回収率
    ("身体障がい", 114, 67, 0.588),
    ("精神障がい", 30, 15, 0.500),
...
PREV_SURVEY_TOTAL = (164, 95, 0.579)
PREV_SURVEY_PERIOD = "令和5年9月11日（月）〜9月29日（金）（令和5年10月5日到着分まで集計）"
