...
CAP_GH = 99                # グループホーム　調査5事業所81人＋ファミリー18人
...
ROWS6 = [
    ...
    ("グループホーム", 5, 7, 99,
     ...
     "調査で把握した5事業所81人に、"
     "介護サービス情報公表システムの個別画面により確認した"
     "グループホームファミリー18人を加えて99人とした。"
     "くるみの郷（東川町）は公表システムに掲載がなく、定員が未確定である"),
...
note(ws, r + 1,
     "注0）グループホームの定員99人は、"
     "居所変更実態調査で把握した5事業所81人に、"
     "介護サービス情報公表システムの個別画面により確認した"
     "グループホームファミリー（東川町・2ユニット18人）を加えたものである。"
     "くるみの郷（東川町）は公表システムに掲載がなく定員が未確定であるため、"
     "含めていない。定員の余裕は本表よりさらに大きい"
     "（住まいと施設の公表名簿との突合 10シート）。"
     ...
     "注2）居住系サービスの区域内定員は255人"
     "（グループホーム99人＋特定施設156人）であり、"
