...
DOCS = [
 ...
 ("村データ","★通いの場の実数（令和3〜7年度）","見える化は令和2年度で更新停止。令和6年度分のみ受領","―","―","一部受領"),
 ("村データ","★高齢者福祉事業（村単独事業）の実績","現行計画の評価に必要","―","―","未受領"),
 ("成果物","第10期 要介護度別認定者数の推計（doc29／data/…推計.csv）","前期・後期別の認定率に分解。基準年が実績と完全一致","2026/09/07","docs/…/29_要介護認定者数の推計.md","作成済"),
 ("国資料","第10期将来推計用人口推計（北塩原村のみ）＋推計の考え方（別紙1・2）","住基ベース推計と補正係数。令和22年まで。厚労省R8.8.24事務連絡／県R8.8.25通知","2026/09/07","docs/…/28_受領資料分析…md §1","受領済"),
 ("村データ","令和8年度 合計所得金額分布調査 調査票（入力済）","所得段階別の第1号被保険者数13段階・合計1,015人。10万円刻みの分布を含む","2026/09/07","docs/…/28_受領資料分析…md §2","受領済"),
 ("村データ","成年後見制度利用促進施策に係る取組状況調査（令和7・8年度 市町村票）","利用者4人、中核機関整備済、市民後見人0人ほか","2026/09/07","docs/…/28_受領資料分析…md §3","受領済"),
 ("村データ","会津権利擁護・成年後見センター 相談件数（令和6・7年度）","本村 令和6年度134件／令和7年度76件。圏域13市町村の比較表","2026/09/07","docs/…/28_受領資料分析…md §3-3","受領済"),
 ("調査票","調査票 第2稿（0904版）","指摘13件のうち11件が反映。必須修正3件を新たに検出","2026/09/04","docs/…/27_調査票第2稿レビュー.md","受領済"),
 ("成果物","第2回策定委員会 資料2・5・6・7（output/08_第2回策定委員会資料.docx）","26表・A4約30頁。資料2と7は本体完成、資料5と6は骨格","2026/09/03","docs/…/26_第2回策定委員会_資料構成.md §11","作成済"),
 ("成果物","集計仕様書（output/07_集計仕様書.xlsx）","6シート。ニーズ80設問・在宅26設問・派生変数20・クロス表20","2026/09/03","docs/…/25_集計仕様書.md","作成済"),
 ("成果物","第2回策定委員会 資料構成（doc26）","資料1〜8・約53頁＋素案別冊。合意事項5点","2026/09/03","docs/…/26_第2回策定委員会_資料構成.md","作成済"),
 ("調査票","調査票 第1稿（ニーズ調査・在宅介護実態調査）","0828版。令和7年8月版・手法Ⅲ標準様式と全面突合","2026/09/02","docs/…/23_調査票第1稿レビュー_ICF分析設計.md","受領済"),
 ...
 ("国資料","令和8年度 評価指標に係る該当状況調査票集計表（都道府県分）","47都道府県・752列。福島県530点・全国26位（前年度468点・42位）","2026/09/25","docs/…/41_交付金_都道府県分の確認.md","受領済"),
 ("国資料","令和8年度 評価指標（都道府県分）全38頁","管内市町村平均得点・著しく得点の低い市町村の判定基準を確認","2026/09/25","docs/…/41_交付金_都道府県分の確認.md","受領済"),
 ("国資料","令和8年度 該当状況調査票集計表（市町村分・全国一覧表）","1,779行×1,563列。本村は通し番号380。既収録の9項目すべてと一致","2026/09/25","docs/…/42_交付金_市町村分の確認.md","受領済"),
 ("国資料","令和8年度 評価指標（市町村分）全42頁","留意点を突合し、未得点のうち61点が計画への記載等で取得できることを特定","2026/09/25","docs/…/42_交付金_市町村分の確認.md","受領済"),
