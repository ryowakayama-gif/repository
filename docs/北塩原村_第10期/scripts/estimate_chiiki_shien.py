...
# ── 延ばす基礎（素案5-2・5-3の採用値＝B案）────────────
#    基準：令和5年度末＝令和6年3月末の実績（「見える化」B1・B4-a）
#    見込み：estimate_certified.py の案B（厚生労働省配布の推計用人口を
#            令和7年12月末の実績にリベースしたもの）
NINTEI = {'基準': 200, '令和9年度': 214, '令和10年度': 217, '令和11年度': 220}
INSURED = {'基準': 1_004, '令和9年度': 1_004, '令和10年度': 995, '令和11年度': 987}
