...
SHEETS = [
    ...
    ('20_是正余地の算定',      '20_是正余地の算定.csv'),
    ('21_是正水準の比較',      '21_是正水準の比較.csv'),
    ('22_推奨案の料金表と増収',  '22_推奨案の料金表と増収.csv'),
    ('23_世帯への影響',       '23_世帯への影響.csv'),
    ('24_段階的是正',         '24_段階的是正.csv'),
]
...
rows = [
    ...
    ('20_是正余地の算定', '★説明資料 表3の根拠。6〜10㎥を11〜50㎥と同単価に揃えた場合の増収余地'),
    ('21_是正水準の比較', '★説明資料 表4・図3の根拠。是正水準4段階＋完全是正の料金と世帯影響'),
    ('22_推奨案の料金表と増収', '★説明資料 表5・表8の根拠。推奨案の料金表・増収額・経費回収率'),
    ('23_世帯への影響', '★説明資料 表6・表10の根拠。月使用量別の月額と2か月請求額'),
    ('24_段階的是正', '★説明資料 表9・図4の根拠。第1段階・第2段階の料金表と段差'),
    ('', ''),
    ...
    ('', ''),
    ('6〜10㎥の是正とは', '現行の6〜10㎥は40.7円/㎥で、11〜50㎥（191.4円/㎥）の4.7分の1しかない'),
    ('', 'この区分だけで従量水量の約4割を流しながら、収入は5%にとどまっている'),
    ('', '11〜50㎥と同単価に揃えると年間8,493,753円（現行比+19.8%）の増収余地がある'),
    ('', 'ただし一度に揃えると月10㎥の世帯が+57.4%となるため、段階的に是正する'),
    ('', '推奨案は「基本使用料は据置・6〜10㎥を40.7円→80円」（是正率26.1%・全体+10%）'),
    ('', ''),
