...
MIRU = [
    ...
    ("同じKPI番号に2つの基準値がないか",
     "別の調査の値を同じKPIの「基準値」と書いていないか",
     "**H06の基準値は①在宅生活改善調査による73.5％**である。"
     "④健康とくらしの調査の「困りごとを解決できず困っている」0.6％は"
     "母集団・設問・分母がいずれも違うため、"
     "**同じH06の基準値ではなく補完指標**と書く。"
     "H14は「採用率と離職率の差」であり、"
     "勤続1年未満19.9％は補足指標である"),
    ("割合の分母を指標名に入れているか",
     "同じ名前で分母の違う割合が2つ出ていないか",
     "**外国人職員37人は全員が施設・通所系**であるため、"
     "主指標は「施設・通所系の介護職員319人に占める割合11.6％」とする。"
     "訪問系を含む回答全体348人を分母とした10.6％は参考値と明記する"),
    ("時点の違う値を足していないか",
     "合算した割合がその表の中で再計算できるか",
     "**特定施設の入居者154人は、令和7年4月1日現在の2施設57人と"
     "令和7年10月6日現在の1施設97人の合計**である。"
     "施設別の入居率98.3％・97.0％を主とし、"
     "合計の98.7％は参考値と書く。"
     "定員も調査の自己申告158人と北海道の名簿156人で2人ちがう"),
    ("目標年度と未達幅の対応",
...
AYAMARI = [
    ("発注者へ送付する成果品に当方の判定方法を書いていた",
     "集計分析報告書 12シートの注に「計画素案の本文と表を章節ごとに読んで"
     "判定している。固定値では書いていない」と書き、"
     "00シートにも「計画素案の実物を読んで判定する」と書いていた。"
     "9月業務報告の表1にも「反映状況を章節ごとに確認して改めた」とあった",
     "令和8年9月24日のご指示（発注者へ提供する文章に受託者の内部の"
     "仕組み・作業経過を書かない）を9月業務報告にだけ当て、"
     "集計分析報告書と結果報告書に当てていなかった",
     "注を「計画素案に反映されているものである」に改めた。"
     "送付区分が「送付」の成果品は、内部の仕組みの語"
     "（固定値・実物から・章節ごとに・判定している・スクリプト名）で"
     "本文と表を機械的に走査する"),
    ...
    ("同じKPI番号に別の調査の値を基準値として置いていた",
     "H06（在宅生活継続困難割合）の基準値が、"
     "①在宅生活改善調査による73.5％と、"
     "④健康とくらしの調査の0.6％の2通りあった",
     "母集団・設問・分母の違う値を、"
     "同じKPIの「基準値」という語で並べていた",
     "④の値を**補完指標**と改め、"
     "H06の基準値は①によることを明記した。"
     "H14も「採用率と離職率の差」と勤続1年未満19.9％を書き分けた"),
    ("同じ割合に2つの分母があった",
     "外国人職員の割合が11.6％（施設・通所系319人）と"
     "10.6％（回答全体348人）の2通りあり、"
     "概要と本文は11.6％、詳細表は10.6％を使っていた",
     "外国人職員37人が全員施設・通所系であることを分母に反映した箇所と、"
     "回答全体で割った箇所が混在していた",
     "**施設・通所系319人を分母とする11.6％を主指標とし、"
     "10.6％は参考値と明記した**"),
    ("時点の違う値を足した割合を確定値として書いていた",
     "特定施設の入居率98.7％が、表の中の定員158人からは"
     "再計算できなかった（154÷158＝97.5％）。"
     "さわやか東神楽館の入居率も97人／100人であるのに100.0％としていた",
     "令和7年4月1日現在の2施設と令和7年10月6日現在の1施設を足し、"
     "分母だけ北海道の名簿による156人を使っていた",
     "**施設別の入居率を主とし、合計は参考値と明記した**。"
     "調査の自己申告の定員158人と名簿の156人の差2人も表に示した"),
