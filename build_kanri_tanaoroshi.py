...
HOKA = [
    ("給付費（令和7年度）", "3町合計 3,213,054,558円",
     "広域連合単位 3,213,054,558円", "0円",
     "令和8年9月25日の再提供により3か年とも要介護度別まで一致した"
     "（確認事項No.87は解決）。従前の表の値3,083,474,291円は"
     "同じファイルの明細と一致していなかった"),
...
AYAMARI = [
    ("令和7年度の給付費の差を抽出条件の違いによるものと整理していた",
     "R8.9.25", "算定",
     "令和8年8月28日受領分の【大雪】令和7年度のファイルの表の値"
     "3,083,474,291円を広域連合の実績として扱い、"
     "「町別に按分すると3町とも上回る」「広域連合のファイルだけ"
     "伸びが趨勢から外れている」と整理していた。"
     "同じファイルの明細を集計すると3町合計と要介護度別まで一致する",
     "再提供を受けたファイルにより差が解消したことを確かめ、"
     "従前の整理を取り下げた。"
     "表（ピボット）の値は、同じファイルの明細と突き合わせてから用いる"),
