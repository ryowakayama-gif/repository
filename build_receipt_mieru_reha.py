...
ws = sheet("05_成果品への反映",
           ...
           "令和8年9月10日、No.3〜No.6について計画素案に反映する"
           "ご指示をいただいたため反映しました。"
           "No.1・No.2（ケアプラン点検実施要領）はご確認をお待ちしています。",
           [4, 26, 40, 30, 22, 20])
...
HANEI = [
    ...
    (3, "計画素案 第2章第3節5",
     "【リハビリテーション専門職の配置】と"
     "【リハビリテーション関係の加算の算定状況】の2表を新設した。"
     "3職種の配置（全国比1.12〜2.41倍）と、"
     "加算7指標の算定状況（うち5指標が全国の2倍以上）。",
     "02・03シート", "反映済み", "反映済"),
    (4, "計画素案 第5章 基本目標5（2）（3）",
     "（2）に福祉用具貸与の種目別算定者数の表（8種目）を新設し、"
     "（3）に調査の対象種目を手すり・スロープ・歩行器の順に"
     "優先する方針と、リハビリテーション専門職等の関与を"
     "既存の加算算定の回路に接続する方針を加えた。",
     "01・02・03シート", "反映済み", "反映済"),
    (5, "計画素案 第5章 基本目標1（1）・基本目標2（1）（3）",
     "基本目標1に医師数（全国の19％）とリハビリテーション専門職の"
     "対比を、基本目標2にリハビリテーションの提供体制が強みであることと、"
     "生活機能向上連携加算の回路を通いの場・地域ケア会議・"
     "住宅改修等の点検へ広げる方針を加えた。",
     "02・03シート", "反映済み", "反映済"),
    (6, "計画素案 第3章第3節",
     "特定福祉用具販売の対計画比128.5％の要因の候補として、"
     "選択制の対象品目であるスロープ（北海道の1.18倍）と"
     "歩行器（同1.21倍）が当区域で多いことを示した。",
     "01シート", "反映済み", "反映済"),
    (7, "計画素案 資料5",
     "見える化システムの使用データにN系列・M1系列・G系列を加え、"
     "L系列12件を用いていない理由を注記した。",
     "00・06シート", "反映済み", "反映済"),
]
for t in HANEI:
    r = body(ws, r, list(t),
             fills={6: (OK_G if t[5] == "反映済" else IN_Y)}, height=56,
