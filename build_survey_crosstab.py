...
FIND = [
    ...
    ("施設入所志向は支え手の有無で決まる",
     ...
     "施設入所志向は心身の状態や経済状況ではなく、在宅の支え手の有無と結びついている。"
...
ws = sheet("17_施設志向と在宅資源", "施設入所志向と在宅の支援資源の関係",
           "第9期の評価では、給付水準の高さが施設・居住系サービスの受給率に集約されること"
...
for nm, fm, cont, ax, use in [
    ("KK_2025_GT", "Excel 1シート", "全設問の単純集計（実数と％）", "総数のみ",
     "本分析の集計値の照合に用いた。広域連合全体の値は完全に一致する"),
